#! /usr/bin/python
#
# functions for managing the set representation of documents in a corpus

# Given a complete inverted index and an optional IDF threshold(indexing.py),
# compute and return the list of set representations of all indexed documents.
...
# compute and return the set representation of the document.
